...
OFF_WAREHOUSE = [
    ...
    ("Petlas", "Oto servis", KAPALI, "", "", "bayi arama reCAPTCHA"),
    ("Lassa", "Oto servis", KAPALI, "", "", "bayi sayfası 404"),
    ...
    ("Enterprise, National, Alamo", "Oto kiralama", DENENMEDI, "", "", ""),
    ("Europcar", "Oto kiralama", DENENMEDI, "", "", ""),
    ("Sixt", "Oto kiralama", DENENMEDI, "", "", ""),
    ("Hertz, Thrifty, Dollar", "Oto kiralama", DENENMEDI, "", "", ""),
    ("Green Motion", "Oto kiralama", DENENMEDI, "", "", ""),
    ("Rent Go", "Oto kiralama", DENENMEDI, "", "", ""),
