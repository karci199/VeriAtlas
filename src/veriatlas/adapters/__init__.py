...
from .tuik_registry import TuikOwnRegistryPopulation, TuikRegistryPopulation
...
ADAPTERS = {
    ...
    "tuik_own_registry_population": TuikOwnRegistryPopulation,
